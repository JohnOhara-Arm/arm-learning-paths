...
The output is similar to the following selected sections. This representative
recording was created on an Arm Neoverse system:
...
In the normal Arm report, the `c2c details` section should confirm
...
Perf C2C cache-line address with a live heap object and its fields, follow the
[Attribute contended cache lines to Java heap objects Learning Path](/learning-paths/servers-and-cloud-computing/java-attribute-cache-lines/).
{{% /notice %}}
